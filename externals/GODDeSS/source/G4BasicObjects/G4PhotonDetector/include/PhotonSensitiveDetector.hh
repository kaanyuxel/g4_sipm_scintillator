...
#ifndef PHOTONSENSITIVEDETECTOR_HH_
#define PHOTONSENSITIVEDETECTOR_HH_
...
public:
	 ...
	 */
	PhotonSensitiveDetector( G4String SDname,				/**< name of the sensitive detector */
				 GODDeSS_DataStorage * dataStorage		/**< pointer to the GODDeSS_DataStorage that is to be used to save the data which was taken by the sensitive detector */
			       )
...
#endif /* PHOTONSENSITIVEDETECTOR_HH_ */
